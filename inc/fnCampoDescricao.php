...
?>
  <label for="custom_page_description">Insira a descrição:</label>
  <textarea name="custom_page_description" id="custom_page_description" rows="4" style="width:100%;"><?php echo esc_textarea($value); ?></textarea>
<?php
}

// Salvar o campo de descrição
function save_custom_page_description($post_id)
{
  ...
  if (isset($_POST['custom_page_description'])) {
    update_post_meta($post_id, '_custom_page_description', sanitize_text_field($_POST['custom_page_description']));
  }
}
